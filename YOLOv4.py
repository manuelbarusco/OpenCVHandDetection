...
class YOLO:
    ...
    def __init__(self, config, model, labels, size=416, confidence=0.25, threshold=0.3):
        ...
        try:
            ...
            raise ValueError("Couldn't find the models and their configurations!")

        layer = self.net.getLayerNames()
        for l in self.net.getUnconnectedOutLayers():
            self.output_names.append(layer[int(l) - 1])
