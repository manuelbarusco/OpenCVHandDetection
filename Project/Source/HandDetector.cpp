...
HandDetector::HandDetector(const Net& p_net, const vector<string>& c_names) {
	...
	colors = { Scalar(255,178,0), Scalar(0,0,255), Scalar(255,0,0), Scalar(76,153,0), Scalar(0,255,0)};
}//HandDetector

/* forward_process()
* This function will perform the forward-step for the neural network
...
/** refineBBox()
* This function refine detection boxes in case they go outside the image
